...
export default function OnboardStepper() {
  ...
  const stepMetadata = [
    { label: "Welcome to Movie!", img: signupImg },
  ...
  return (
    <div className="flex w-full h-screen gap-4">
      <div className="w-[40%] flex items-center flex-col bg-black/80 justify-center">
        ...
        >
          ...
          {hasCompletedAllSteps && (
            <Card className="bg-background w-[64%] h-[20rem] border-none">
              <CardHeader>
                <CardTitle>You are now ready to use Movie!</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  You have completed all the steps required to use Movie. Now
